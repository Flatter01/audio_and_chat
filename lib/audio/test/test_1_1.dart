...
class AudioPlayerExample2 extends StatefulWidget {
  @override
  _AudioPlayerExample2State createState() => _AudioPlayerExample2State();
}

class _AudioPlayerExample2State extends State<AudioPlayerExample2> {
